...
export function PricingSummary() {
  return (
    <section id="precos" className="scroll-mt-16 border-t border-outline-variant/60 bg-surface-container-low px-margin-mobile py-24 md:px-margin-desktop">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {PLANS.map((plan, index) => (
            <Reveal key={plan.name} delay={index * 100} className="h-full">
              <div
                className={
                  "artisanal-card flex h-full flex-col gap-4 rounded-2xl border bg-card p-7 " +
                  (plan.highlighted
